<div style="width: 900px;height: 600px;">
    {foreach from=$hotRes1 item=row}
        <div style="width: 900px;height: 280px;float: left;text-align: center">
            ...
            <div style="width: 150px;height: 160px;float: left;margin: 30px">
                <span>品牌：{$row["brand"]}</span><br><br>
                <span>型号：{$row["model"]}</span><br><br>
            </div>
            <div style="width: 150px;height: 160px;float: left;margin: 30px">
                <span>市场价：{$row["m_price"]}</span><br><br>
    ...
    <div id="divPage">
        ...
        <a href="index.php?pag={$before}&page=Hot">上一页 </a>第【{$curPage}】页，共【{$totalPage}】页<a href="index.php?pag={$next}&page=Hot">下一页</a>
        <a href="index.php?pag={$totalPage}&page=Hot">尾页</a>
    </div>
</div>
<style type="text/css">
    #divPage
